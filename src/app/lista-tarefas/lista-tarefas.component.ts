...
import { checkButtonTrigger, highlightedStateTrigger, shownStateTrigger, filterTrigger, formButtonTrigger, flyInOutTrigger, shakeTrigger } from './lista-tarefas.animations';
